...
import { Search, MapPin, Star, MessageCircle, ArrowRight, X } from 'lucide-react'
...
export default function VendorDiscovery({ onClose, onStartChat }: VendorDiscoveryProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-hidden flex flex-col relative">
        <button
          onClick={onClose}
          className="absolute top-6 right-6 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full p-1.5 transition-all z-10"
