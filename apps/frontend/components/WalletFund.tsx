...
import { Wallet, CreditCard, ArrowRight, CheckCircle, Copy, X } from 'lucide-react'
      ...
      <div className="bg-white rounded-2xl p-6 max-w-md w-full relative">
        ...
        {step === 'wallet' && (
          <div>
            ...
            <div className="bg-linka-emerald/10 border border-linka-emerald/20 rounded-lg p-4 mb-6">
              <p className="text-sm text-linka-emerald dark:text-emerald-300">
