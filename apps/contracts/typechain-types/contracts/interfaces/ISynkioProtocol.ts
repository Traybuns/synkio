...
export interface ISynkioProtocolInterface extends Interface {
  getEvent(
...
export interface ISynkioProtocol extends BaseContract {
  connect(runner?: ContractRunner | null): ISynkioProtocol;
  waitForDeployment(): Promise<this>;

  interface: ISynkioProtocolInterface;
