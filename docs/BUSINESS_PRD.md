# Synkio: Business Product Requirements Document
...
Synkio bridges the trust gap in social commerce by enabling secure, verifiable transactions directly within conversations on platforms like Farcaster, WhatsApp, and web chat. We solve the problem of fragmented discovery and untrustworthy transactions by combining AI-powered conversation with blockchain escrow, creating the first trust layer for Web3 social commerce.

Synkio also provides universal payment capabilities, allowing users to send and request payments from anyone—even non-users—using any supported token or fiat currency across multiple blockchain networks. This positions Synkio as a comprehensive payment platform that works like UseAzza but with enhanced multi-chain support, fiat integration, and conversational AI.
...
### Synkio: Trust in Every Conversation

Synkio is a conversational marketplace and universal payment platform that lets people buy, sell, and transact naturally within their existing conversations. We remove the trust barrier through:
...
4. **Multi-Platform**: Works on WhatsApp, Web, and more coming
5. **Universal Payments**: Send and request payments from anyone via email, phone, username, or link
6. **Multi-Chain & Multi-Asset**: Pay with any token, receive in any currency, automatic conversion
7. **Fiat Integration**: Seamless fiat on/off-ramp via Bread for non-crypto users
...
**Synkio enables:**
1. See offer on Farcaster
2. Chat with Synkio AI: "I want to buy this"
...
**Or send payment directly:**
1. User: "Send $50 to Chidera"
2. Synkio: "Enter password to authorize"
3. Payment sent (Chidera receives notification or claim link)
4. Chidera can receive in any currency (auto-converted if needed)
...
**3. Universal Access**
- Works wherever you chat (WhatsApp, Web, future platforms)
- Fiat or crypto, through our fiat on-ramp partnerships
- Simple onboarding, even for crypto beginners

**4. Engagement & Rewards**
- Points system rewards user activity and engagement
- No monetary value, zero cost to company
- Gamification encourages platform usage
- Optional future conversion to tokens (not guaranteed)
...
- Earn points for transactions and referrals
...
- Earn points for successful transactions and referrals
...
- Enable universal payments accessible to everyone
...
**Conservative 3-Phrase Projections:**

**Phrase 1:** 10K active users, $5M transaction volume
- Focus on whatsapp and web
- Crypto-native users only
- Proof of concept in multiple markets

**Phrase 2:** 100K active users, $50M transaction volume
- WhatsApp integration in Africa
- Fiat on-ramp drives adoption
- Vendor network expansion

**Phrase 3:** 500K active users, $250M transaction volume
...
- Synkio provides fiat on/off-ramp via Bread
- User converts fiat to crypto (ETH, stablecoins) or vice versa
- Transaction completes on Synkio
- Synkio earns commission on conversion
...
- Launch MVP on web interface (PWA)
...
Synkio solves a real problem: **trust in social commerce**. We're not just another payment platform or marketplace—we're the first conversational escrow layer for Web3 social commerce, with universal payment capabilities that work like UseAzza but better.
