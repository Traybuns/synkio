...
SVC_NAME=`systemd-escape --path "vsts.agent.spontaneousmanji.Default.bun-Latitude-7490.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (spontaneousmanji.Default.bun-Latitude-7490)"
